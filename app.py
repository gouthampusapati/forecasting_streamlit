...
daily_data_predict_table=run_query('select date, close from public.daily_data_predict_new where close is not null')
df_daily=pd.DataFrame(daily_data_predict_table)
...
monthly_data_predict_table=run_query('select date, close from public.monthly_data_predict_new where close is not null')
df_monthly=pd.DataFrame(monthly_data_predict_table)
